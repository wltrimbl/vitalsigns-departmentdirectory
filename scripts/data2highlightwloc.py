...
#    print ("G", g) 
    ...
    loc = getfields(d, ["provider_business_practice_location_address_city_name", "provider_business_practice_location_address_state_name"] )
    ...
    if getfields(d, ["number_of_prescriptions"])[0] != "null" :
         TABLE.append("<span style=color:black>{} medicare prescriptions</span>".format(getfields(d, ["number_of_prescriptions"])[0]) )
    else:
